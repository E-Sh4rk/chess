        ...
        private def newWhitePlayer () : Player =
        {
            ...
            else
            {
                settingsPanel.whitePlayerType match
                {
                    ...
                    case Player_Type.AlphaBeta => return new AlphaBetaAI(new EvalStd(settingsPanel.alphaBetaAttack, settingsPanel.alphaBetaDefense), settingsPanel.alphaBetaDepth)
